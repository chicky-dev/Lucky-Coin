...
public class Flip3dAnimation extends Animation {
    ...
    public Flip3dAnimation(ImageView imageView, int curDrawable, int nextDrawable,
                           float fromXDegrees, float toXDegrees, float fromYDegrees,
    ...
    protected void applyTransformation(float interpolatedTime, Transformation transformation) {
        ...
        animateZoom(interpolatedTime);
        animateRotate(interpolatedTime, xDegrees);
        camera.save();
    ...
    public void animateZoom(float interpolatedTime) {
    ...
    public void animateRotate(float interpolatedTime, float xDegrees) {
